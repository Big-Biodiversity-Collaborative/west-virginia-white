...
obs_map <- get_map(location = map_bounds,
                   source = "stamen",
                   maptype = "terrain")
map_title <- paste0(genus_name, " ", species_name, " observations")
...
obs_title <- paste0(genus_name, " ", species_name, " observations")
...
wls_p_value <- wls_summary$coefficients[2, 4]
