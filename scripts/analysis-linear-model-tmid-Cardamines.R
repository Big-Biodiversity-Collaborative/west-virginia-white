...
write.csv(x = model_compare,
          file = "output/model-compare-tmid-Cardamines.csv",
          row.names = FALSE)
...
# Write to a file
write.csv(file = "output/model-table-tmid-Cardamines.csv",
          x = model_table,
          row.names = FALSE)
...
write.csv(x = all_deltas,
          file = "output/changes-table-tmid-Cardamines.csv",
          row.names = FALSE)
...
write.csv(x = compared_to_insect,
          file = "output/changes-rel-insect-tmid-Cardamines.csv",
          row.names = FALSE)
...
line_colors <- c("Pieris virginiensis" = "#BEBADA",
                 "Cardamine concatenata" = "#FB8072",
                 "Cardamine diphylla" = "#8DD3C7")
